...
from dictsqlite.main import DictSQLite, DBSyncedList, DBSyncedSet
...
class TestDBSyncedSet:
    ...
    def test_set_creation_and_basic_operations(self, db: DictSQLite):
    ...
    def test_set_add_operations(self, db: DictSQLite):
    ...
    def test_set_remove_operations(self, db: DictSQLite):
    ...
    def test_set_update_operations(self, db: DictSQLite):
    ...
    def test_set_intersection_operations(self, db: DictSQLite):
    ...
    def test_set_difference_operations(self, db: DictSQLite):
    ...
    def test_set_symmetric_difference_operations(self, db: DictSQLite):
    ...
    def test_set_clear_operations(self, db: DictSQLite):
    ...
    def test_set_operator_overloads(self, db: DictSQLite):
        ...
        # Test |= (union)
        result = sync_set.__ior__({3, 4, 5})
        assert result is sync_set
        ...
        # Test &= (intersection)
        result = sync_set.__iand__({2, 3, 4})
        assert result is sync_set
        assert sync_set == {2, 3}
        ...
        result = sync_set.__ixor__({2, 3, 4})
        assert result is sync_set
        assert sync_set == {1, 4}

    def test_set_sync_called_on_mutations(self, db: DictSQLite):
