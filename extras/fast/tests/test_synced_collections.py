...
from dictsqlite import DBSyncedList
...
class TestDBSyncedList:
    ...
    def test_list_creation_and_basic_operations(self, db: FastDictSQLite):
    ...
    def test_list_append_operations(self, db: FastDictSQLite):
    ...
    def test_list_insert_operations(self, db: FastDictSQLite):
    ...
    def test_list_remove_operations(self, db: FastDictSQLite):
    ...
    def test_list_extend_operations(self, db: FastDictSQLite):
    ...
    def test_list_slice_operations(self, db: FastDictSQLite):
    ...
    def test_list_clear_operations(self, db: FastDictSQLite):
    ...
    def test_list_reverse_and_sort(self, db: FastDictSQLite):
    ...
    def test_list_count_and_index(self, db: FastDictSQLite):
...
class TestIntegratedSyncedCollections:
    """Test synced collections integrated with actual FastDictSQLite instances."""
    ...
    def test_list_persistence_across_sessions(self, db_path):
        ...
        db2 = FastDictSQLite(str(db_path))
    ...
    def test_nested_collections_with_sync(self, db: FastDictSQLite):
