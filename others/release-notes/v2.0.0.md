...
DictSQLite v2.0.4は、**Rust実装による完全な書き直し**により、v1.8.8から**5〜300倍のパフォーマンス向上**を実現したメジャーアップデートです。
...
- **[README_V4.2_JP.md](../beta-versions/dictsqlite_v4.2/README_V4.2_JP.md)** - v2.0.4の完全ガイド
