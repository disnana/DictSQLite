...
def main():
    ...
    print("\n  2. Fastest版 (DictSQLite-Fastest)")
    print("     - ソースコード: others/beta-versions/dictsqlite-fastest/")
    print("     - 実装: APSWベース（高性能版）")
    print("\n  3. Beta版 (DictSQLite-Fastest Beta)")
    print("     - ソースコード: others/beta-versions/dictsqlite-fastest/beta/")
    print("     - 実装: メモリ最適化版（LRUキャッシュ搭載）")
    print("\n" + "="*80)
    print()
